...
function setupMenu() {
    ...
    function setupWatermark() {
        ...
        watermark.innerHTML = `<span style="text-shadow: -1px 0.5px 0 #72ff72, -2px 0px 0 #2f672e;">Painelzinho Da Maldade 😈</span> <span style="color:gray; padding-left:2px; font-family: Arial, sans-serif; font-size:10px">${ver}</span>`;
    ...
    function setupStatusPanel() {
        ...
        const update = async () => statsPanel.innerHTML = `
            <span style="text-shadow: -1px 0.5px 0 #p, -2px 0px 0 #2f672e;">Painelzinho da maldade 😈</span>
...
function setupMain(){
    function spoofQuestion() {
        const phrases = [ "Feito por GuizeraaXyz", "Feito por GuizeraaXyz", "Feito por GuizeraaXyz" ];
    ...
    function changeBannerText() {
        const phrases = [ "[🌿] Feito por GuizeraaXyz", "[🌿] Feito por GuizeraaXyz", "[🌿] Feito por GuizeraaXyz", "[🌿] Feito por GuizeraaXyz", "[🌿] Feito por GuizeraaXyz", "[🌿] Feito por GuizeraaXyz" ];
        setInterval(() => { 
    ...
    async function autoAnswer() {
        ...
        while (true) {
            ...
            await delay(featureConfigs.autoAnswerDelay*60000);
        }
    }
